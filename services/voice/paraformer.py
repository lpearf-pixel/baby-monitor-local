...
from tools.voice_asr_environment import validate_asr_environment
...
class ParaformerProcess:
    """Own one bounded offline Paraformer subprocess and framed in-memory PCM pipe."""
    ...
    def __init__(
        ...
        *,
        project_root: Path,
        environment_validator: Callable[..., Path] = validate_asr_environment,
    ...
    def _exchange(
        self, frame: bytes, timeout: float, *, maximum_bytes: int
    ) -> object:
        process = self._process
