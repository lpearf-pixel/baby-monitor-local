...
def _render_html(run: OfflineScenarioRunV1) -> str:
    ...
    return (
        ...
        "safety. Visual counts are observational; Guardian counts come from independent "
        "synthetic semantic oracles. Guardian PASS means those counts matched the "
        "tracked expectations.</p>"
