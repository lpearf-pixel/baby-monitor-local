...
- [ ] **Step 3: Implement the minimum closed types**
...
VoiceMatchKind = Literal["exact", "corrected", "high_risk_candidate"]
...
class VisualScenarioV1(OfflineScenarioContract):
    ...
    expected_frames: int = Field(ge=1, le=18_000)
...
class VoiceScenarioStepV1(OfflineScenarioContract):
    ...
    expected_match_kind: VoiceMatchKind | None
...
- [ ] **Step 4: Keep the existing four-scenario fixture valid**

Before adding new scenarios, update the existing entries exactly:

| Scenario | Contract change |
|---|---|
| `SAFE-SLEEP-01` | `expected_frames=65`, relationship `INDEPENDENT` |
| `FACE-OCCLUSION-01` | `expected_frames=50`, provenance `GENERATED_VISUAL`, relationship `INDEPENDENT` |
| `ADULT-INTERVENTION-01` | `expected_frames=50`, relationship `INDEPENDENT` |
...
- [ ] **Step 1: Write exact-suite RED tests**
...
- [ ] **Step 3: Add the prone and outside scenarios**
...
- [ ] **Step 4: Add the exact diaper and burping declarations**
...
- [ ] **Step 5: Write and run Guardian GREEN tests**
...
- [ ] **Step 1: Write Voice identity RED tests**
...
- [ ] **Step 3: Implement exact per-step comparison**
...
- [ ] **Step 4: Extend the generated fixture provider**
...
- [ ] **Step 5: Run GREEN and adjacent Voice gates**
...
- [ ] **Step 2: Write exact-frame RED tests**
...
- [ ] **Step 4: Implement the pure binding validator**
...
- [ ] **Step 5: Implement exact frame settlement**

After mapping bounded counts, accept visual PASS only when:

```python
exact = (
    aggregate.frames_total == visual.expected_frames
    and aggregate.frames_processed == visual.expected_frames
...
- [ ] **Step 6: Run GREEN and adjacent corpus gates**
...
- [ ] **Step 1: Write result/report RED tests**
...
- [ ] **Step 3: Populate the fixed bounded candidate key set**
...
- [ ] **Step 4: Propagate and render independence**
...
- [ ] **Step 5: Run GREEN and privacy checks**
...
- [ ] **Step 1: Write fixed CLI RED tests**
...
- [ ] **Step 3: Implement the exact constants and aggregate output**
...
- [ ] **Step 4: Run CLI GREEN and dry-runs**
...
- [ ] **Step 5: Run the actual bounded public/generated suite**
...
- [ ] **Step 1: Run the fresh focused gate**
...
- [ ] **Step 2: Run complete software/static gates**
...
- [ ] **Step 3: Run bounded repository/privacy checks**
...
- [ ] **Step 5: Update factual handoff documents**
