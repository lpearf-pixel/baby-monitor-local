...
- [ ] **Step 1: Fetch and prove the exact remote base**
...
- [ ] **Step 2: Protect existing worktrees**
...
- [ ] **Step 3: Run the software-only baseline**
...
- [ ] **Step 1: Execute detailed Tasks 1-6 with focused commits**
...
- [ ] **Step 2: Run the actual bounded public/generated flow**
