...
- Active Camera Reply review line: `codex/xiaomi-camera-reply-lifecycle-review`, based
  ...
  Camera Reply remains disabled with no marker. Task 14 full software/review checkpoint
  is next.
...
6. Keep Camera Reply V3 disabled. Tasks 8–13 software are complete through `015f6e4`;
   installed diagnostics and playback remain unrun. D2 causality remains unproven.
   The Task 12 live microphone chain remains unrun. Next execute Task 14's full
   software/review checkpoint without hardware playback. Do not force UDP/TCP, create
   a second camera connection or continue D3/D4.
