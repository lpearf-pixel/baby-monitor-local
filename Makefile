...
help:
	...
	@echo "  make alpha-visual-corpus-prepare Prepare the fixed three-clip public smoke set"
	@echo "  make alpha-visual-regression Replay the fixed public smoke set offline"
